...
G4PSH103D::G4PSH103D(G4String name, G4int ni, G4int nj, G4int nk, G4int depi,
                     G4int depj, G4int depk)
    : G4PSH10(name), fDepthi(depi), fDepthj(depj), fDepthk(depk) {
    fNi = ni;
    fNj = nj;
    fNk = nk;
}
...
G4int G4PSH103D::GetIndex(G4Step *aStep) {
